nidelva_us10 = load('results_Nidelva\error_sensor_loop.mat', 'res_og_clu', 'ssim_og_clu');
nidelva_us5 = load('results_Nidelva\error_sensor_loop_US5.mat', 'res_og_clu', 'ssim_og_clu');

%%
nidelva_us10_meansub = load('results_Nidelva\error_sensor_loop_US10_meansub.mat', 'res_og_clu', 'ssim_og_clu');
nidelva_us5_meansub = load('results_Nidelva\error_sensor_loop_US5_meansub.mat', 'res_og_clu', 'ssim_og_clu');
...
% Set additional properties
fname = 'output_Nidelva/mse_sensortuning_meansub_NRMSR';
picturewidth = 20; % Set figure width in centimeters
hw_ratio = 0.55; % Height-width ratio
