%loading datasets
data_ran = load('results_DNS\DNS_20sensors_random_full.mat');
data_qr = load('results_DNS\DNS_20sensors_QR_full.mat');
...
[PSD_orig, f_orig] = PSD_calc(data_normalized, 1);
[PSD_ran, f_ran] = PSD_calc(recon_ran(:,:,9) , 1); %PSD of the random sensor case where US = 10
[PSD_qr, f_qr] = PSD_calc(recon_qr(:,:,9), 1); %PSD of the QR sensor case where US = 10
...
fname = 'output_DNS/PSD_reconstruction_US10';
...
fname = 'output_DNS/PSD_reconstruction_QR_UStuning';
